...
def test_cryptocompare_asset_support(cryptocompare):
    ...
    exceptions = (
        ...
        evm_address_to_identifier(address='0x6589fe1271A0F29346796C6bAf0cdF619e25e58e', chain_id=ChainID.ETHEREUM, token_type=EvmTokenKind.ERC20),  # noqa: E501  # grain(farm) but cc has Granary
        evm_address_to_identifier(address='0x24086EAb82DBDaa4771d0A5D66B0D810458b0E86', chain_id=ChainID.BINANCE_SMART_CHAIN, token_type=EvmTokenKind.ERC20),  # noqa: E501  # we have an older meme coin pepeai
        ...
        evm_address_to_identifier(address='0xc335Df7C25b72eEC661d5Aa32a7c2B7b2a1D1874', chain_id=ChainID.BINANCE_SMART_CHAIN, token_type=EvmTokenKind.ERC20),  # noqa: E501  # different ice
...
def test_coingecko_identifiers_are_reachable(socket_enabled):  # pylint: disable=unused-argument
    ...
    symbol_checked_exceptions = (  # This is the list of already checked assets
        ...
        evm_address_to_identifier(address='0xAcf79C09Fff518EcBe2A96A2c4dA65B68fEDF6D3', chain_id=ChainID.BINANCE_SMART_CHAIN, token_type=EvmTokenKind.ERC20),  # noqa: E501
        # simp but coingecko has socol
        evm_address_to_identifier(address='0xD0ACCF05878caFe24ff8b3F82F194C62Ed755707', chain_id=ChainID.BINANCE_SMART_CHAIN, token_type=EvmTokenKind.ERC20),  # noqa: E501
        # coingecko has a turbos in sui
        evm_address_to_identifier(address='0x0678Ca162E737C44cab2Ea31b4bbA78482E1313d', chain_id=ChainID.BINANCE_SMART_CHAIN, token_type=EvmTokenKind.ERC20),  # noqa: E501
